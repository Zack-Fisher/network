...
use crate::world_interaction::analysis::{AnalyseBundle, Analysis, AnalysisEventType, AnalysisEvent};
...
pub fn build_button (
    ...
    prefab_q: Query<(Entity, &ButtonPrefab), Added<ButtonPrefab>>,
